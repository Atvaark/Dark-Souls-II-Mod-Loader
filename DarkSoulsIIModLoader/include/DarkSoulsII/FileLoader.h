...
public:
	...
	BYTE is_output_deque_initialized; //0x006C 
	char _0x006D[3];
	PlainConditionSignal signal1; //0x0070 
	PlainConditionSignal signal2; //0x0078 
	PlainLightMutex mutex1; //0x0080 
	void * p_thread; //0x00A0 
	BYTE is_running; //0x00A4 
	BYTE do_use_system_cache; //0x00A5 
	char _0x00A6[10];
	DWORD read_chunk_size; //0x00B0 
	char _0x00B4[8];
	DWORD sleep_time; //0x00BC 
	DWORD sleep_or_wait; //0x00C0 
	char _0x00C4[92];
	DWORD performance_count; //0x0120 
	char _0x0124[4];
